...
class EjemploTree(Gtk.Window):
    ...
    def __init__(self):
        ...
        rbtHome = Gtk.RadioButton.new_with_mnemonic (None, label = "_Home")
        rbtMuller = Gtk.RadioButton.new_with_mnemonic_from_widget (rbtHome,label = "_Muller") # new_with_laberl_from_widget
        rbtOutros = Gtk.RadioButton.new_with_mnemonic_from_widget (rbtHome,label = "_Outros")
